...
const chatSchema = new mongoose.Schema({
  ...
  rollingSummary:       { type: summarySchema, default: () => ({}) },
...
// Ensure we don't overwrite models when hot reloading in Next.js
export const Workspace = mongoose.models.workspaces || mongoose.model("workspaces", workspaceSchema);
